...
Penghasilan”, yang mensyaratkan Perusahaan
dan entitas anaknya untuk memperhitungkan
...
based on terms agreed by the parties, in
which such terms may not be the same as
...
Taxes”, which requires the Company and its
subsidiaries to account for the current and
future tax consequences of the future
recovery (settlement) of the carrying amount
of assets (liabilities) that are recognized in
...
recognized when an assessment is received
