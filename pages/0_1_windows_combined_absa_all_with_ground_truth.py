...
LOGS_DIR = PROJECT_ROOT / "logs_windows"
REGISTRY_PATH = LOGS_DIR / "registry.json"
MAPPING_PATH = PROJECT_ROOT / "data" / "aspect_mapping_windows.json"
GT_PATH = PROJECT_ROOT / "data" / "ground_truth_windows" / "absa_mapping.csv"
